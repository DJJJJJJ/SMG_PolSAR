...
The High-resolution Airborne PolSAR vehicle recognition dataset (ATR-HAPVR) can be found in [sciencedb](https://doi.org/10.57760/sciencedb.j00001.01627 "ATR-HAPVR").
...
@article{
  ...
  title={PolSAR vehicle recognition via scattering mechanism-driven hybrid attention},
  
  author={Deng, Jie and Wang, Wei and Zhang, Huiqiang and Xiang, Deliang and Zhang, Jun},
...
@misc{
  0378a4e05fdf43c4b81187e4448e369c,
